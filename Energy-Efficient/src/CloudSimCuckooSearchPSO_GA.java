 ...
 */
public class CloudSimCuckooSearchPSO_GA {
	...
	public static void main(String[] args) {
		...
		try {
			...
			DatacenterBrokerCSPSO broker = createBroker();
			...
			Log.printLine("cuckoo search particle swarm optimization with Genetic Algorithm ends....");
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	private static DatacenterBrokerCSPSO createBroker(){

		DatacenterBrokerCSPSO broker = null;
		try {
			broker = new DatacenterBrokerCSPSO("Broker");
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
	...
	private static void printCloudletList(List<Cloudlet> list,List<Vm> list1) {
		...
		String indent = "    ";
		Log.printLine();
		Log.printLine("========== OUTPUT of cuckoo search Particle optimization with Genetic Algorithm ==========");
